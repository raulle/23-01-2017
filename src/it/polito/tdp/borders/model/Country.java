...
public class Country implements Comparable<Country>{
	...
	public Country(int cCode, String stateAbb, String stateName) {
		...
		this.confini= new ArrayList<Country>();
	}
	...
	public void setConfini(List<Country> confini) {
		this.confini = confini;
	}
	
	public void addConfine(Country c){
		confini.add(c);
	}
	...
	public String toString() {
		return String.format("[%s]", stateAbb);
	}

	@Override
	public int compareTo(Country other) {
		// TODO Auto-generated method stub
		return -(this.confinanti-other.confinanti);
	}
