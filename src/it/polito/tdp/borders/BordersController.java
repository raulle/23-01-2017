...
public class BordersController {
    ...
    //	if(18162006)
    	if(s.length()!=4){
    		txtResult.setText("Errore lunghezza");
    		return;
    	}
    	try {
    		int anno= Integer.parseInt(s);
    		if(anno<1816 || anno>2006){
    			txtResult.setText("anno compreso tra 1816 e 2006");
    			return;
    		}							
    		for(Country c : model.getPaesiAnno(anno))
    			txtResult.appendText("Stato: "+c.toString()+" confini: "+c.getConfinanti()+"\n");
